...
app.post('/save-response', function(req, res, next){
  ...
  fs.stat('responses.csv', function (err, stat) {
      if (err == null) {
          ...
          var headers= ["responseId", "startTime","endTime","testType","Self-handicappingPre", "Self-handicappingPost","activityPoints","Self-handicappingPost2","Self-handicappingRawPre","Self-handicappingRawPost", "Self-handicappingRawPost2", "flowRawPoints", "flow", "gender","age", "ethnicity", "sexualOrientation", "civilState", "city", "universityEducation","institucion","educationLevel","conclusion", "email","whatsapp"].join(";") + "\n" + row
